...
【プリントのレイアウト情報】
■ 国語以外（英語・数学など）: A4縦レイアウト
  - ヘッダーは上部に横書きで、左から順に: 科目名、単元名、得点○/○、ステップ○/○
■ 国語（漢字）: A4横レイアウト
  - ヘッダーは左側に縦書きで: 単元名、得点○/○、ステップ○/○

【読み取り対象】
1. subject_name: 科目名（「英語」「数学」「国語」「理科」「社会」「算数」のいずれか。国語の漢字プリントはA4横で縦書きヘッダーが特徴。判別できない場合はnull）
2. content_group_name: 教材名（プリントのタイトルやヘッダーから判読。判別できない場合はnull）
3. unit_name: 単元名（プリント上の単元表記をそのまま転記。判別できない場合はnull）
