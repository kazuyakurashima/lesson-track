...
■ 英語: A4縦レイアウト
  - ヘッダーは上部に横書きで、左から順に:
    ...
    4. 得点○/○
    5. ステップ○/○
  - 例: 「英語　英文法１ / 【I】主語と動詞,品詞　得点28/31　ステップ1/2」
  - 「英文法１」→ content_group_name は「英文法」
  - 「英文法 入門」→ content_group_name は「英文法 入門」
  - 教材名の数字（１、1など）に注意して正確に区別すること
...
【重要な区別ルール】
- 英語の「英文法１」と「英文法 入門」は別の教材。「入門」の有無で区別する
- 数学の「数学１年」と「1年のまとめ」は別の教材。「まとめ」の有無で区別する
- 数学の「数学２年」と「2年のまとめ」も同様

【読み取り対象】
1. subject_name: 科目名（「英語」「数学」「国語」「理科」「社会」「算数」のいずれか。判別できない場合はnull）
2. content_group_name: 教材名（ヘッダーの科目名の直後に記載されている教材名をそのまま転記。判別できない場合はnull）
