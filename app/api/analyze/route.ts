...
■ 国語（漢字）: A4横レイアウト
  - ヘッダーは右側に縦書きで、上から順に:
    ...
    2. 「/」区切り
    3. 単元名（縦書き。省略せず完全に読み取ること）
    4. 得点○/○
    5. ステップ○/○
  - 例: 「東１年 / 漢字道場1・文法の窓1　18/21　ステップ2/2」
  - 「東１年」→ content_group_name は「東京書籍1年 漢字」
  - 「東２年」→ content_group_name は「東京書籍2年 漢字」
  - ※縦書きのため文字が読みにくい場合があるが、「/」の後〜得点欄の前が単元名
  - ※「道場」が「同情」等に誤読されやすいので注意。漢字教材の文脈で「道場」が正しい
...
3. unit_name: 単元名（ヘッダーの「/」の後に記載されている単元名を**省略せず完全に**そのまま転記。
   ...
   「平面図形」のように途中で切らないこと。得点欄の直前までが単元名。判別できない場合はnull）
