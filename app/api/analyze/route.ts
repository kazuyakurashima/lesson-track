...
■ 国語（漢字）: A4横レイアウト ※縦書きなので特に注意して読み取ること
  ...
  - 【東京書籍1年の単元名リスト（参考）】以下のいずれかに一致するはず:
    「朗読の世界~ さまざまな表現技法」「漢字道場1・文法の窓1」
    「私たちの未来・話の~・インタビュー」「漢字道場2 音読み・訓読み」
    「日本語探検2・オオカミを~①」「オオカミを~②・情報の~・「食文化」~」
    「漢字道場3・日本語探検3・図書館~」「平和のバトン①」「平和のバトン 2」
    「さんちき①」「さんちき②・場面と~・案内や~」
    「日本語探検4~ 「写真」の意見文」「漢字道場4 漢字の部首・月夜の浜辺」
    「移り行く浦島太郎の物語・伊曽保物語」「竹取物語・矛盾」
    「漢字道場5形の似た漢字」「ニュースの見方を考えよう~ 漢字道場6」
    「少年の日の思い出①」「少年の日の思い出②」
    「少年の~③・日常~・グループ~・文法の窓3」「漢字道場7・わたしの~・多様性と~」
